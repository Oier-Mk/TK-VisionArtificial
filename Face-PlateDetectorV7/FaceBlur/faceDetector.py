...
#relative = os.getcwd() + os.path.sep + "Face-PlateDetectorV7" + os.path.sep + "FaceBlur" #local
relative = os.getcwd() + os.path.sep + "FaceBlur" #colab

#yoloPath = '/Users/mentxaka/yolov5' #path yolo de Oier
#yoloPath = r"C:\Users\eneko\yolov5" #path yolo de Eneko

def loadYolo(yoloPath):
    weightsPath = relative + os.path.sep + "weights" + os.path.sep + "facesV7.pt" 
    print(yoloPath)
    print(weightsPath)
